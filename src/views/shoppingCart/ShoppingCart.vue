<template>
  <div id="shopping-cart">
    ...
    <!--底部汇总-->
    <shopping-cart-bottom-bar :message="message" :is-show-message="isShowMessage" @cancelClick="cancelClick" />
  </div>
</template>

<script>
import CartList from './childComps/CartList'
import ShoppingCartBottomBar from './childComps/ShoppingCartBottomBar'
